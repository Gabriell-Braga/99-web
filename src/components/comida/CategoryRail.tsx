  ...
  return (
    <div className="relative flex items-center gap-3">
      <button
        ...
        className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border-99 bg-white text-black-99 transition-colors duration-150 hover:bg-subtle-99 lg:flex"
      >
      ...
      <div className="relative min-w-0 flex-1">
        ...
        {/* Esfumaçado nas duas bordas, para o trilho não terminar cortado. */}
        <div
          aria-hidden="true"
